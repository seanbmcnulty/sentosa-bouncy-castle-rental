...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D0c6dJ4T.js
...
var SITE = {
	...
	seoDescription: "Rent an all-white Oxford bounce house with slide on Sentosa Island. S$149 a day, free delivery and pickup. You set up — we collect. For kids’ birthdays, condos and hotel functions.",
	whatsappDisplay: "+65 XXXX XXXX",
	whatsappE164: "",
	googleFormEmbedUrl: "",
	priceSgd: 149,
	depositDisplay: "S$150",
	depositNote: "Refundable damage deposit required — S$150, confirmed on booking.",
...
var DEFAULT_WHATSAPP_TEXT = "Hello — I’d like to book the all-white bounce house on Sentosa.";
var styles_default = "/assets/styles-DfhQwiFT.css";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "keywords",
				content: "white bouncy castle rental Sentosa, bounce house Sentosa, inflatable slide rental Singapore, kids party Sentosa, condo function bounce house"
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-DAb6z27a.mjs");
...
//#endregion
export { isWhatsAppReady as a, SITE as i, DEFAULT_WHATSAPP_TEXT as n, whatsappUrl as o, PHOTOS as r, router_exports as t };
